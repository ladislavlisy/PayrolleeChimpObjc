...
@interface TermOrderCompareCodeOrderTest : XCTestCase
...
@implementation TermOrderCompareCodeOrderTest
...
- (void)testShould_Compare_TwoInstancesWith_Same_Code_And__DifferentCodeOrder_AsGreater
{
    XCTAssertTrue([_orderTwo compare:_orderOne]==NSOrderedDescending);
}

- (void)testShould_Compare_TwoInstancesWith_Same_Code_And_Different_CodeOrder_AsLess
{
